import { Collection, GuildMemberRoleManager, type Role } from "discord.js";
import { isRegExp } from "util/types";
import { replaceMentionCharacters } from "../utils";

export default class GuildMemberRoleManagerExtension {
  declare cache: GuildMemberRoleManager["cache"];

  constructor() {
    Object.defineProperties(GuildMemberRoleManager.prototype, {
