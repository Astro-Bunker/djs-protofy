...
import GuildEmojiRoleManagerExtension from "../prototypes/GuildEmojiRoleManager";
...
import GuildMemberRoleManagerExtension from "../prototypes/GuildMemberRoleManager";
...
export class DJSProtofy {
  constructor() {
    ...
    new GuildEmojiRoleManagerExtension();
    new GuildMemberExtension();
    new GuildMemberManagerExtension();
    new GuildMemberRoleManagerExtension();
